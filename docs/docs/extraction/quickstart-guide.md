...
5. For faster OCR performance, you can use the nemoretriever-ocr-v1 container. Helm is now configured to use nr-ocr by default. Simply set the following values in your .env file:
